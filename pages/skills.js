            ...
            <CardContent sx={{ position:'relative', maxWidth: '100%', display:'flex', overflowX:'auto'}}
             >
                ...
                <Stack direction='row' justifyContent="space-evenly" alignItems='center' style={{display:'flex', textAlign:'center', paddingInlineStart: '4vw'}}>
                    ...
                    <Card sx={{ minWidth: {xs: '345px', xl:'670px'}, maxWidth: {xs: '345px', xl:'670px'}, marginInlineEnd: {xs:'2.5vw'}, marginInlineStart:{xl:'25vw'}, bgcolor: blackBeauty[800]}} >
                        <CardContent>
                            ...
                            <Typography sx={{color: blackBeauty[100], textAlign:'left', fontFamily: 'Bellota Text'}} variant='p'   paragraph>
                            {!expanded ? 'As a Detroit-based full-stack web developer, I have a passion for computer science, physics, and figuring out how things work. I bring my enthusiasm and technical expertise to every project I work on, and I am always looking for new opportunities to expand my skills and knowledge. ' : ''}
                            </Typography>
                        </CardContent>
                        <CardActions disableSpacing>
                            <Typography variant='p' component='div' sx={{textAlign: 'right', color:blackBeauty[100], }} style={{fontSize: '1.5rem'}}></Typography>
                            <ExpandMore
                            expand={expanded}
                        ...
                        <Collapse in={expanded} timeout="auto" unmountOnExit>
                            <CardContent style={{ fontFamily:"Bellota Text", fontWeight:'100', fontSize: '1.05rem'}}  sx={{overflow:'auto', height: {xs: '22.5vh'}}}>
                    ...
                    <Card sx={{ minWidth: {xs: '345px', xl:'670px'}, maxWidth: {xs: '345px', xl:'670px'}, marginInlineEnd: {xs:'2.5vw'}, bgcolor: blackBeauty[800] }}>
                    <CardContent>
                    ...
                    <Card sx={{ minWidth: {xs: '345px', xl:'862.5px'}, maxWidth: {xs: '345px', xl:'862.5'}, marginInlineEnd: {xs:'2.5vw', xl:'25vw'}, bgcolor: blackBeauty[800] }}>
                        <CardContent>
                        ...
                        <Stack direction='row' justifyContent="center" alignItems='center' style={{display:'flex', textAlign:'center', paddingInlineStart: '4vw'}}>

                        <Box sx={{bgcolor: blackBeauty[800],padding: '2vh', borderRadius: '10px', marginInlineEnd: '2vw'}}>
                            
                        <Grid container  sx={{marginInlineEnd: '5vw', width: {xs: '68vw', xl:'700px'}  }}>
                                <Grid item xs={3}>
                        ...
                        <Collapse in={expanded2} timeout="auto" unmountOnExit>
                            <CardContent style={{letterSpacing: '.85vw', fontWeight:'100', fontSize: '1.05rem', width: 'inherit'}}  sx={{ height: {xs: '22.5vh'}}}>
                                    <Typography variant='p' component='div' sx={{ textAlign: 'left', fontFamily: 'Bellota Text', color: blackBeauty[100], letterSpacing: '2px', fontSize: {xs: '1.05rem'}}}>
                        ...
                        <Box sx={{bgcolor: blackBeauty[800],padding: '2vh', borderRadius: '10px', marginInlineEnd: '2vw'}}>
                            ...
                            <Grid container minWidth={300} sx={{marginInlineEnd: '5vw', width: {xs: '68vw', xl:'700px'} }}>
                                <Grid item xs={3}>
                                    <div style={{paddingBlockStart:'1vh'}}>
